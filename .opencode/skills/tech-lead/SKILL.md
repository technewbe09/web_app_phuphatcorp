---
name: tech-lead
description: Đọc BA Analysis và tạo task list kỹ thuật chi tiết cho feature mới - xác định BE tasks (migration, service, API, validation) và FE tasks (hook, page, component, i18n), ước lượng effort, xác định thứ tự thực hiện. Dùng khi user nói "tạo task list", "phân tích BA", "xác định tasks", "tech lead".
---
